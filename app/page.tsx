        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-xl">
              Plate2Place connects restaurants, weddings and home kitchens with
...
function Stories() {
  const stories = [
    {
      quote:
        'We used to waste 30+ kg of buffet food a night. Now every gram reaches Dharavi within an hour. The team and the volunteers are extraordinary.',
      name: 'Priya Menon',
      title: 'F&B Manager · Taj Palace Mumbai',
      avatar: 'PM',
      tone: 'from-emerald-500 to-teal-600',
    },
    {
      quote:
        'Plate2Place doubled our nightly meal capacity without us hiring a single extra coordinator. The matching is uncannily accurate.',
      name: 'Mumbai Food Bank',
      title: 'NGO partner · Dharavi',
      avatar: 'MFB',

...
Plate2Place is a polished, production-style web app that connects donors (restaurants, hotels, weddings, home kitchens) with verified NGOs and volunteers — so surplus food gets rescued in minutes instead of being thrown away.
...
- **Cohesive Indian context** — real cities, real NGOs (Mumbai Food Bank, Robin Hood Army, Akshaya Patra, Annamrita), real restaurant partners
...
| NGO        | `contact@mumbaifoodbank.org`     | `demo1234`  |
| Volunteer  | `amit.k@volunteer.com`           | `demo1234`  |
| Admin      | `admin@Plate2Place.org`        | `admin1234` |
...
6. Sign out → sign in as **Mumbai Food Bank** → your donation is in the **smart-matched donations** list

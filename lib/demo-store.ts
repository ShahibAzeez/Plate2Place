...
// Storage layer
// ────────────────────────────────────────────────────────────────────────────────
const STORAGE_KEY = 'zwl-demo-store-v2';
...
export const DEMO_CREDENTIALS = [
  { role: 'donor', email: 'priya@tajpalace.com', password: 'demo1234', label: 'Priya Menon (Taj Palace, Mumbai)' },
  { role: 'ngo', email: 'contact@mumbaifoodbank.org', password: 'demo1234', label: 'Mumbai Food Bank' },
  { role: 'volunteer', email: 'amit.k@volunteer.com', password: 'demo1234', label: 'Amit Kumar (Volunteer)' },
  { role: 'admin', email: 'admin@Plate2Place.org', password: 'admin1234', label: 'Aarav Sharma (Admin)' },
] as const;

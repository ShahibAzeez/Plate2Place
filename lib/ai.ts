...
export function analyseDescription(text: string, sizeBytes = 0): AiAnalysis {
  ...
  const ngos = [
    { name: 'Mumbai Food Bank', distanceKm: 1.4, capacity: 1200 },
  ...
  const common: SmartInsight[] = [
    {
      ...
      description:
        'Based on weather + festival data, NGOs in Mumbai will need ~28% more meals tomorrow. Stock up your kitchens.',
      tone: 'warning',

  ...
  const testimonials = [
    {
      ...
      content: "Plate2Place has transformed how we handle excess food. Instead of throwing it away, we now help feed families in our community. It's incredibly rewarding.",
      rating: 5,
